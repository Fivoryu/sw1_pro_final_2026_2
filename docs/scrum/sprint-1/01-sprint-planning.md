...
- Validar estimaciones y alcance con el equipo (GAP-072/073: responsables por plataforma — ids §6.1).
- Redactar criterios de aceptación de las HU del Sprint 1 (GAP-070).
