...
Desarrollador a cargo: Cervantes Arancibia Roberto Carlos
...
**Carga planificada consolidada:** aproximadamente 107 HRS. La cifra corresponde a la planificación por valor esperado; las fechas exactas y la validación de la estimación permanecen pendientes (GAP-072 y GAP-084). La asignación de responsables por PB/HU quedó documentada en las fichas de §1.3 (sorteo aleatorio del equipo, 2026-08-24).
